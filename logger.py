...
modified from stackoverflow chinsese translation blog
"""
import sys
import logging
...
def init_logger(log_fn=None, quiet=False):
    ...
    logging.getLogger("methyutils").debug(f'Command: """{" ".join(sys.argv)}"""')


def get_logger(module_name="methyutils"):
    return logging.getLogger(module_name)


if __name__ == "__main__":
    sys.stderr.write("This is logger module. See commands with `methyutils -h`")
    sys.exit(1)
